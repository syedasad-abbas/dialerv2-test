...
const LoopSocket_1 = require("./include/LoopSocket");
...
(function (STEP) {
    ...
    STEP[STEP["SOCKET_CONNECTED"] = 1] = "SOCKET_CONNECTED";
    STEP[STEP["SUBSCRIBE_SENT"] = 2] = "SUBSCRIBE_SENT";
    STEP[STEP["UA_ON_NEWSUBSCRIBE"] = 3] = "UA_ON_NEWSUBSCRIBE";
    STEP[STEP["NOTIFIER_ON_SUBSCRIBE"] = 4] = "NOTIFIER_ON_SUBSCRIBE";
    STEP[STEP["SUBSCRIBER_ON_ACCEPTED"] = 5] = "SUBSCRIBER_ON_ACCEPTED";
    STEP[STEP["SUBSCRIBER_ON_ACTIVE"] = 6] = "SUBSCRIBER_ON_ACTIVE";
    STEP[STEP["SUBSCRIBER_ON_NOTIFY_1"] = 7] = "SUBSCRIBER_ON_NOTIFY_1";
    STEP[STEP["NOTIFIER_ON_UNSUBSCRIBE"] = 8] = "NOTIFIER_ON_UNSUBSCRIBE";
    STEP[STEP["NOTIFIER_TERMINATED"] = 9] = "NOTIFIER_TERMINATED";
    STEP[STEP["SUBSCRIBER_ON_NOTIFY_2"] = 10] = "SUBSCRIBER_ON_NOTIFY_2";
    STEP[STEP["SUBSCRIBER_TERMINATED"] = 11] = "SUBSCRIBER_TERMINATED";
})(STEP || (STEP = {}));
    ...
    test('should handle subscriber/notifier communication', () => new Promise(resolve => {
        ...
        function createSubscriber(ua) {
            ...
            subscriber.on('notify', (isFinal, notify, body, contType) => {
                step++;
                // 'receive notify'
                expect(step === STEP.SUBSCRIBER_ON_NOTIFY_1 ||
                    step === STEP.SUBSCRIBER_ON_NOTIFY_2).toBe(true);
                ...
                expect(subsState === 'pending' ||
                    subsState === 'active' ||
                    subsState === 'terminated').toBe(true); // 'notify subscription-state'
        ...
        function createNotifier(ua, subscribe) {
            ...
            notifier.on('subscribe', (isUnsubscribe, subs, body, contType) => {
                ...
                expect(++step).toBe(isUnsubscribe
        ...
        const config = {
            sockets: new LoopSocket_1.default(), // message sending itself, with modified Call-ID
            uri: REQUEST_URI,
        ...
        ua.on('newSubscribe', (e) => {
            ...
            const canUse = accepts?.some((v) => v.includes(CONTENT_TYPE));
